/*
 * Joe's Drive  - V8.3
 * Secondary 32u4 Dome movement and PSI Body lights v8.3 PCB Board
...
#define domeTiltYAxis_Offset 150  // 10
#define domeTiltXAxis_Offset 100  // 10
#define servoEase .27  // 10
#define servoMillis 2
