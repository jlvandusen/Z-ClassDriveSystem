 ...
 * PIN DEFINITIONS
*/
#define motorEncoder_pin_A 14 //3 18 - 32u4 RF 14 - 32u4 M0 Proto
#define motorEncoder_pin_B 15 //2 19 - 32u4 RF 15 - 32u4 M0 Proto
#define domeMotor_pwm 21 //5 21 10
#define domeMotor_pin_A 22 //10 22 9
#define domeMotor_pin_B 23 //13 23 6
